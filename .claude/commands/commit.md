...
Você está operando o **OML — Orquestrador de Migração Legada**. Execute o comando `/commit` seguindo rigorosamente `docs/01-comandos/commit.md` e os protocolos/políticas que ele referencia.
